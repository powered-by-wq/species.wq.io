...
ROOT_URLCONF = 'speciestracker.urls'
...
WSGI_APPLICATION = 'speciestracker.wsgi.application'
ANONYMOUS_PERMISSIONS = (
    "report.add_report",
    "species.add_species",
